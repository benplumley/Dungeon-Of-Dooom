...
public class Player implements GameItemConsumer {
	...
	private CompassDirection lastDirection = CompassDirection.fromString("S");
	...
	public void setLastDirection(CompassDirection direction) {
		this.lastDirection = direction;
	}

	public String getLastDirection() {
		return this.lastDirection.toString();
	}
